...
import lessons.lesson9.task3.figure.RightTriangle;
        ...
        for (Figure figure : figures) {
            ...
            if (figure instanceof TwoParameterFigure) {
                ...
                System.out.printf("%s [%d, %d]: Длина - %.1f, Площадь - %.1f.%n",
                        figure.getClass().getSimpleName(), figure.getParameter1(), twoParameterFigure.getParameter2(),
                        figure.getLength(), figure.getArea());
            }
        }
